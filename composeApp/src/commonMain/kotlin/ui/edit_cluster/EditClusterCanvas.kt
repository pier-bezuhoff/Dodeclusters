    ...
    for (ix in selection) {
        ...
        when (val o = objects[ix]) {
            ...
            is Point -> if (showPoints) {
                val color = objectColor ?: selectedPointColor // idk about diff select-color
